...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    if not user_id:
        message.reply_text("I don't see a shinobi around sir")
        return

    if int(user_id) in SUDO_USERS:
        message.reply_text("I spy, with my sharingan... a sudo user war! Why are you guys turning on each other?")
        return
    ...
    if user_id == bot.id:
        message.reply_text("Sudo style gban justu *won't work on me*")
        return
    ...
    if user_chat.type != 'private':
        message.reply_text("That's not a shinobi!")
        return
